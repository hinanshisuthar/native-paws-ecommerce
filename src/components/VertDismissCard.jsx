        ...
        <div className="card-badge" id={product._id}>
            <div className="product">
                <div className="prod-container">
                    ...
                    <span className="btn-badge-dismiss" onClick={() => wishlistDispatch({type: 'REMOVE_FROM_WISHLIST', payload: product})}><i className="fa-solid fa-heart px-sm" id="close-card" style={{color: '#f34e4e'}}></i></span> 
                </div>
